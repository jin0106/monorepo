export type WidthType = `w-${number}` | 'w-full' | 'w-auto' | 'w-fit' | `w-${number}/${number}` | `w-[${string}]`
...
export type MinHeightType = `min-h-${number}` | `min-h-[${string}]` | 'min-h-full' | `min-h-${number}/${number}`

export type MaxHeightType = `max-h-${number}` | `max-h-[${string}]` | 'max-h-full' | `max-h-${number}/${number}`
...
export type TextHoverColorType = `hover:text-${string}` | `hover:text-${string}-${number}`

export type TextActiveColorType = `active:text-${string}` | `active:text-${string}-${number}`

export type TextDisabledColorType = `disabled:text-${string}` | `disabled:text-${string}-${number}`
...
export type BasisType = 'basis-full' | `basis-${number}` | `basis-${number}/${number}`
